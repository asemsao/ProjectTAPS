			...
			<div class="navigation-bar-content container">
				...
				<ul class="element-menu">
					...
					<li><a class="dropdown-toggle element" href="#"><i
						...
						<ul class="dropdown-menu" data-role="dropdown">
							<li><a href="javascript:menu('employeeReportSupervisor');"><span
									class="icon-clipboard-2"></span> Employee Report</a></li>
					...
					<li><a class="dropdown-toggle element" href="#"><i
						...
						<ul class="dropdown-menu" data-role="dropdown">
							<li><a href="javascript:menu('report');"><span
									class="icon-clipboard-2"></span> Employee Report</a></li>
					...
					<li><a class="dropdown-toggle element" href="#"><i
						...
						<ul class="dropdown-menu" data-role="dropdown">
							<li><a href="javascript:menu('employee');"><span
									class="icon-user"></span> Employee</a></li>
							<li><a href="javascript:menu('organization');"><span
