					...
					<table class="table">
						...
						<tr>
							<td colspan="3" class="text-right">
								...
								%>
										<button class="primary" onclick="javascript:report('printReportBOM','<%=session.getAttribute("organizationCode")%>')">
								...
								%>
										<button class="primary" onclick="javascript:report('printReportBU','<%=session.getAttribute("organizationCode")%>')">
											Generate Report Business Unit
										</button>
								<% 
									} 
									if (session.getAttribute("organizationLevel").equals("2")) {
								%>
										<button class="primary" onclick="javascript:report('printReportDept','<%=session.getAttribute("organizationCode")%>')">
											Generate Report Department
										</button>
								<% 
									} 
								%>
