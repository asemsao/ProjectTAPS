							...
							<tr>
								...
								<th class="text-center" colspan=2>
									<div class="input-control text">
										<html:text property="searchKeyword" name="manageRoleForm"
							...
							<logic:notEmpty name="manageRoleForm" property="listMember">
								<logic:iterate id="manageRole" name="manageRoleForm"
									...
									<tr>
										...
										<td class="text-center"><logic:equal value="0"
												name="manageRole" property="isAdmin">
												<div class="input-control switch" data-role="input-control">
													<label class="inline-block" style="margin-right: 20px">
														<input type="checkbox" class="grantAdmin"
														value="<bean:write name="manageRole"
													property="employeeDomain" />" />
														<span class="check"></span>
													</label>
												</div>
											</logic:equal> <logic:notEqual value="0" name="manageRole"
												property="isAdmin">
												<div class="input-control switch" data-role="input-control">
													<label class="inline-block" style="margin-right: 20px">
														<input type="checkbox" class="grantAdmin"
										...
										<div class="pagination">
											<ul>
												...
												<li class="disabled"><a>Page <bean:write
															name="manageRoleForm" property="page" /> of <bean:write
															name="manageRoleForm" property="maxpage" /></a></li>
												...
												<li class="disabled"><a>Total Record <bean:write
															name="manageRoleForm" property="countRecord" /></a></li>
											</ul>
										</div>
									</td>
