				...
				<html:form action="/dashboard" method="POST" styleId="dashboardComment">
					...
					<table class="table">
						...
						<tr>
							...
							%>
									<td>
										<b>AdHoc to </b> : <bean:write property="selfAssignBean.adhocFullName" name="dashboardForm" />
									</td>
							<%
								}
							%>
						...
						<tr>
							...
							<td class="field-separator">:</td>
							<td colspan=2>
								<html:textarea property="selfAssignBean.description" name="dashboardForm" styleClass="input-control textarea"></html:textarea>
							</td>
						</tr>
						...
						<tr>
							...
							<td class="field-separator">:</td>
							<td colspan=2>
								<html:textarea property="selfAssignBean.comment" name="dashboardForm" styleId="comment" styleClass="input-control textarea"></html:textarea>
							</td>
						</tr>
						<tr>
