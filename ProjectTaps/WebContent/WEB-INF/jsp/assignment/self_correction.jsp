						...
						<tbody>
							...
							%>
								...
								<tr>
									...
									<td class="field-separator">:</td>
									<td colspan=3>
										<html:textarea property="selfAssignBean.description" name="selfAssignmentForm" readonly="true" styleClass="input-control textarea"></html:textarea>
									</td>
								</tr>
							<%
								} else {
							...
							%>
									<tr>
										...
										<td class="field-separator">:</td>
										<td colspan=3>
											<html:textarea property="selfAssignBean.comment" name="selfAssignmentForm" styleClass="input-control textarea"></html:textarea>
										</td>
									</tr>
							<%
								}
