			...
			<div class="row row-taps shadow-taps">
				<html:form action="/employeeReport" method="post">
					<input type="hidden" id="message"
						value="<bean:write property="message" name="employeeReportForm" />">
						...
						<tr>
							...
							%>
									<td class="text-right field-form"><a
										...
										data-hint-position="bottom"> <img alt=""
											src="<%=request.getContextPath()%>/images/ADD_ASSIGNMENTT.png"></a>
									</td>
							<%
							...
							%>
									<td class="text-right field-form"><a
										...
										data-hint="New Self Assignment" data-hint-position="bottom">
											<img alt=""
											src="<%=request.getContextPath()%>/images/ADD_ASSIGNMENTT.png"></a>
									</td>
							<%
