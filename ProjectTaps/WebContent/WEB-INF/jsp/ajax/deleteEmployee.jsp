			...
			<thead>
				<tr>
						...
						<div class="pagination">
							<ul>
								...
								<li class="disabled"><a>Page <span
										...
										id="max-page-assignment-delete"><bean:write name="ajaxForm"
					...
					<th class="text-center"><button type="button"
							class='button danger' onclick="javascript:chooseAssignmentDelete()">Delete</button>
							<button type="button"
							class='button info' onclick="javascript:chooseAssignmentDelete()">Cancel</button>
							</th>
				</tr>
			</thead>
		</table>
