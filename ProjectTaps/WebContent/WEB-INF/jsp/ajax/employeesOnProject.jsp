			...
			<tr>
				...
				<th class="text-center" colspan=3>
					<div class="input-control text">
						<html:text property="searchKeyword" name="ajaxForm" styleClass="search-keyword-employee-on-project" onkeydown="if (event.keyCode == 13){ javascript:pagingEmployeeOnProject('search'); return false;}"></html:text>
						...
						<logic:iterate id="employee" name="ajaxForm" property="listEmployeesOnProject">
							<tr>
								<td class="text-center">
									<input type='radio' name='employee_choose_on_project' value='<bean:write name="employee" property="employeeDomain" />@<bean:write name="employee" property="employeeName" />' />
								</td>
