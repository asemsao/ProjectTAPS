...
<body>
	<html:form action="/ajax" method="post" >
		<html:hidden property="projectCode" styleId="projectCode-project-update" name="ajaxForm" />
		<html:hidden property="task" styleId="task-project-update" name="ajaxForm" />
		<html:hidden property="mode" styleId="mode-project-update" name="ajaxForm" />
		<html:hidden property="page" styleId="page-project-update" name="ajaxForm" />
		<html:hidden property="maxpage" styleId="maxpage-project-update" name="ajaxForm" />
		<html:hidden property="assignmentCategory" styleId="assignmentCategory-project-update" name="ajaxForm" />
		<html:hidden property="assignmentType" styleId="assignmentType-project-update" name="ajaxForm" />
		<html:hidden property="paramProjectCode" name="ajaxForm" styleId="projectCode-project-update"/>
				...
				<tr>
					<th class="text-center" colspan=2>
						<div class="input-control select">
							<html:select property="searchCategory" name="ajaxForm" styleClass="search-category-project-update">
				...
				<tr>
					<th colspan=3 class="text-center">
						<div class="pagination">
							<ul>
								<li class="first"><a onclick="javascript:pagingProjectUpdate('first');">
									<i class="icon-first-2"></i></a></li>
								<li class="prev"><a onclick="javascript:pagingProjectUpdate('prev');">
									<i class="icon-previous"></i></a></li>
								<li class="disabled"><a>Page <span id="current-page-project-update">
									<bean:write name="ajaxForm" property="page" /></span> of <span id="max-page-project-update">
									<bean:write name="ajaxForm" property="maxpage" /></span></a></li>
								<li class="next"><a onclick="javascript:pagingProjectUpdate('next');">
									<i class="icon-next"></i></a></li>
								<li class="last"><a onclick="javascript:pagingProjectUpdate('last');">
									<i class="icon-last-2"></i></a></li>
								<li class="disabled"><a>Total Record <span id="total-record-project-update">
